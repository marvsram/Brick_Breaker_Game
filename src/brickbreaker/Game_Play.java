...
class Game_Play extends JPanel implements KeyListener, ActionListener{
     private boolean play = false;
		...
		{    		
			...
			if(!play) {
                            ...
                            g.drawString("Start?", 320, 420);
                            
                            g.setColor(Color.yellow);
                            g.setFont(new Font("serif", Font.BOLD,23));
			g.drawString("Press left (<) or right (>) arrow key \n to start", 120, 450);
			 
                         
                         
                         g.setColor(Color.green);
                         g.setFont(new Font("serif",Font.BOLD, 20));
                         g.drawString("Press (M) Menu", 300, 510);
			...
			if(totalBricks <= 0)
			{
	             ...
	             g.drawString("Press (E) to Exit", 250, 410);
			}
			...
			if(ballposY > 570)
	        {
	             ...
	             g.setColor(Color.RED);
	             g.drawString("Press (E) to Quit Game", 230,400);
	        }
